...
SELECT app_name, reviews, min_installs, DIV(min_installs, reviews) AS proportion FROM analytics WHERE min_installs >=100000 ORDER BY DIV(min_installs, reviews) DESC LIMIT 1;